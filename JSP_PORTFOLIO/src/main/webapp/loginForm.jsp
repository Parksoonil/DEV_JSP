...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <div class="text-center mt-4">
            <a href="searchID.jsp" class="text-blue-500 text-sm">아이디 찾기</a> | 
            <a href="searchPassword.jsp" class="text-blue-500 text-sm">비밀번호 찾기</a>
        </div>
        <div class="text-center mt-4">
            <a href="submitForm.jsp" class="text-blue-500 text-sm">회원가입</a>
        </div>
    </div>
</body>
</html>